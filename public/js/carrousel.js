...
/***/ "./node_modules/draw-image-normalized/index.js":
/*!*****************************************************!*\
  !*** ./node_modules/draw-image-normalized/index.js ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./node_modules/kenburns/lib/Base.js":
/*!*******************************************!*\
  !*** ./node_modules/kenburns/lib/Base.js ***!
  \*******************************************/
/*! no static exports found */
...
var _rectClamp = __webpack_require__(/*! rect-clamp */ "./node_modules/rect-clamp/index.js");

var _rectClamp2 = _interopRequireDefault(_rectClamp);

var _rectMix = __webpack_require__(/*! rect-mix */ "./node_modules/rect-mix/index.js");

var _rectMix2 = _interopRequireDefault(_rectMix);
 ...
 * An easing function.
 */
var clamp = function clamp(bound, sourceSize) {
  return (0, _rectClamp2.default)(bound, [0, 0, sourceSize.width, sourceSize.height]);
};
...
var KenBurnsBase = function () {
  function KenBurnsBase() {
    _classCallCheck(this, KenBurnsBase);

    this.clamped = true;
    this.background = [0, 0, 0, 0];
  }

  _createClass(KenBurnsBase, [{
    key: "animate",
     ...
     */
    value: function animate(source, fromCrop, toCrop, duration) {
      var _this = this;

      var easing = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : identity;

      (0, _invariant2.default)(source, "source is required. Got: %s", source);
      (0, _invariant2.default)(duration && !isNaN(duration), "duration is required and must be a number. Got: %s", duration);
      (0, _invariant2.default)(typeof easing === "function", "easing must be a function. Got: %s", easing);
      return new Promise(function (resolve) {
        var start = void 0;
        var render = function render(now) {
          ...
          _this.animateStep(source, fromCrop, toCrop, easing(p));
        };
        (0, _raf2.default)(render);
      });
    }
    ...
    key: "animateStep",
    value: function animateStep(source, fromCrop, toCrop, progress) {
      var sourceSize = this.getSourceSize(source);
      var viewport = this.getViewport();
      var applyClamp = this.clamped ? clamp : identity;
      var fromCropBound = applyClamp(typeof fromCrop === "function" ? fromCrop(viewport, sourceSize) : fromCrop, sourceSize);
      var toCropBound = applyClamp(typeof toCrop === "function" ? toCrop(viewport, sourceSize) : toCrop, sourceSize);
      var bound = applyClamp((0, _rectMix2.default)(fromCropBound, toCropBound, progress), sourceSize);
      if (isNaN(bound[0])) {
        (0, _invariant2.default)(false, "NaN value found in bound=(" + String(bound) + "). Something was wrong for animateStep(" + String(source) + ",(" + String(fromCropBound) + "),(" + String(toCropBound) + ")," + progress + ") sourceSize=(" + sourceSize.width + "," + sourceSize.height + ") viewport=(" + viewport.width + "," + viewport.height + ")");
      }
...
exports.default = KenBurnsBase;
//# sourceMappingURL=Base.js.map

/***/ }),

/***/ "./node_modules/kenburns/lib/Canvas2D.js":
/*!***********************************************!*\
  !*** ./node_modules/kenburns/lib/Canvas2D.js ***!
  \***********************************************/
/*! no static exports found */
...
var _drawImageNormalized = __webpack_require__(/*! draw-image-normalized */ "./node_modules/draw-image-normalized/index.js");

var _drawImageNormalized2 = _interopRequireDefault(_drawImageNormalized);

var _cssRgba = __webpack_require__(/*! ./utils/cssRgba */ "./node_modules/kenburns/lib/utils/cssRgba.js");

var _cssRgba2 = _interopRequireDefault(_cssRgba);

var _Base = __webpack_require__(/*! ./Base */ "./node_modules/kenburns/lib/Base.js");
 ...
 */
var KenBurnsCanvas2D = function (_KenBurnsBase) {
  _inherits(KenBurnsCanvas2D, _KenBurnsBase);

  /**
   * Create a Canvas2D KenBurns with a Canvas 2D Context.
   *
   */
  function KenBurnsCanvas2D(ctx) {
    _classCallCheck(this, KenBurnsCanvas2D);

    var _this = _possibleConstructorReturn(this, (KenBurnsCanvas2D.__proto__ || Object.getPrototypeOf(KenBurnsCanvas2D)).call(this));

    _this.ctx = ctx;
    return _this;
  }

  _createClass(KenBurnsCanvas2D, [{
    key: "draw",
    value: function draw(image, rect) {
      var ctx = this.ctx,
      ...
      if (background[3] !== 0) {
        ctx.fillStyle = (0, _cssRgba2.default)(this.background);
        ctx.fillRect.apply(ctx, viewport);
      }
      _drawImageNormalized2.default.apply(null, [ctx, image].concat(rect).concat(viewport));
    }
  }, {
    key: "getViewport",
    ...
    key: "getSourceSize",
    value: function getSourceSize(source) {
      if (source instanceof HTMLVideoElement) {
        var videoWidth = source.videoWidth,
  ...
  return KenBurnsCanvas2D;
}(_Base2.default);

exports.default = KenBurnsCanvas2D;
//# sourceMappingURL=Canvas2D.js.map

/***/ }),

/***/ "./node_modules/kenburns/lib/DOM.js":
/*!******************************************!*\
  !*** ./node_modules/kenburns/lib/DOM.js ***!
  \******************************************/
/*! no static exports found */
...
/**
  ...
  */
var KenBurnsDOM = function (_KenBurnsBase) {
  _inherits(KenBurnsDOM, _KenBurnsBase);

  /**
   * Create a DOM KenBurns with a container element (block element recommended).
   */
  function KenBurnsDOM(container) {
    _classCallCheck(this, KenBurnsDOM);

    var _this = _possibleConstructorReturn(this, (KenBurnsDOM.__proto__ || Object.getPrototypeOf(KenBurnsDOM)).call(this));

    _this.container = container;
    _this._currentBackgroundColorStyle = container.style.backgroundColor;
  ...
  _createClass(KenBurnsDOM, [{
    ...
    key: "getSourceSize",
    value: function getSourceSize(source) {
      return source instanceof Image || source instanceof HTMLImageElement ? source : source.getBoundingClientRect();
    }
  }, {
    key: "draw",
    value: function draw(source, rect) {
      ...
      var backgroundColor = (0, _cssRgba2.default)(this.background);
      if (backgroundColor !== this._currentBackgroundColorStyle) {
        this._currentBackgroundColorStyle = backgroundColor;
        this.container.style.backgroundColor = backgroundColor;
      }
      var viewport = this.getViewport();
      var scale = (viewport.width / rect[2]).toFixed(4); // no need to handle the height dimension because ratio is preserved
      var translate = (-rect[0]).toFixed(2) + "px," + (-rect[1]).toFixed(2) + "px";
...
exports.default = KenBurnsDOM;
//# sourceMappingURL=DOM.js.map

/***/ }),

/***/ "./node_modules/kenburns/lib/WebGL.js":
/*!********************************************!*\
  !*** ./node_modules/kenburns/lib/WebGL.js ***!
  \********************************************/
/*! no static exports found */
 ...
 */
var KenBurnsWebGL = function (_KenBurnsBase) {
  _inherits(KenBurnsWebGL, _KenBurnsBase);

  /**
   * Create a KenBurnsWebGL with a WebGL Context.
   */
  function KenBurnsWebGL(gl) {
    _classCallCheck(this, KenBurnsWebGL);

    var _this = _possibleConstructorReturn(this, (KenBurnsWebGL.__proto__ || Object.getPrototypeOf(KenBurnsWebGL)).call(this));

    _this.gl = gl;
    _this.shader = (0, _glShader2.default)(gl, vert, frag);
  ...
  _createClass(KenBurnsWebGL, [{
    ...
    key: "draw",
    value: function draw(texture, bound) {
      var gl = this.gl;
      if (!gl) return;
    ...
    key: "getSourceSize",
    value: function getSourceSize(texture) {
      var _texture$shape = _slicedToArray(texture.shape, 2),
          width = _texture$shape[0],
          height = _texture$shape[1];

      return { width: width, height: height };
    }
  }]);

  return KenBurnsWebGL;
}(_Base2.default);

exports.default = KenBurnsWebGL;
//# sourceMappingURL=WebGL.js.map

/***/ }),

/***/ "./node_modules/kenburns/lib/index.js":
/*!********************************************!*\
  !*** ./node_modules/kenburns/lib/index.js ***!
  \********************************************/
/*! no static exports found */
...
exports.crop = exports.DOM = exports.WebGL = exports.Canvas2D = undefined;

var _rectCrop = __webpack_require__(/*! rect-crop */ "./node_modules/rect-crop/index.js");

var _rectCrop2 = _interopRequireDefault(_rectCrop);

var _Canvas2D = __webpack_require__(/*! ./Canvas2D */ "./node_modules/kenburns/lib/Canvas2D.js");

var _Canvas2D2 = _interopRequireDefault(_Canvas2D);

var _WebGL = __webpack_require__(/*! ./WebGL */ "./node_modules/kenburns/lib/WebGL.js");

var _WebGL2 = _interopRequireDefault(_WebGL);

var _DOM = __webpack_require__(/*! ./DOM */ "./node_modules/kenburns/lib/DOM.js");

var _DOM2 = _interopRequireDefault(_DOM);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.Canvas2D = _Canvas2D2.default;
exports.WebGL = _WebGL2.default;
exports.DOM = _DOM2.default;
exports.crop = _rectCrop2.default;
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./node_modules/kenburns/lib/utils/cssRgba.js":
/*!****************************************************!*\
  !*** ./node_modules/kenburns/lib/utils/cssRgba.js ***!
  \****************************************************/
/*! no static exports found */
...
exports.default = function (_ref) {
  ...
  return "[number, number, number, number](" + Math.round(255 * r) + "," + Math.round(255 * g) + "," + Math.round(255 * b) + "," + a + ")";
};
//# sourceMappingURL=cssRgba.js.map
...
/***/ "./node_modules/rect-clamp/index.js":
/*!******************************************!*\
  !*** ./node_modules/rect-clamp/index.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./node_modules/rect-crop/index.js":
/*!*****************************************!*\
  !*** ./node_modules/rect-crop/index.js ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./node_modules/rect-mix/index.js":
/*!****************************************!*\
  !*** ./node_modules/rect-mix/index.js ***!
  \****************************************/
/*! no static exports found */
...
$('document').ready(function () {
  ...
  var kenDiv = document.getElementById('div');
  var kenburn = new KenBurns.DOM(kenDiv);
  kenburn.animate(kenImage, rect_crop__WEBPACK_IMPORTED_MODULE_1___default()(0.4, [0.2, 0.38]), rect_crop__WEBPACK_IMPORTED_MODULE_1___default.a.largest, 5000, bezier_easing__WEBPACK_IMPORTED_MODULE_2___default()(0.6, 0.0, 1.0, 1.0));
